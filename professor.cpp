...
Professor::Professor(): QObject(), QGraphicsPixmapItem() {
    //set the graphic
    setPixmap(QPixmap(":/images/professor.png"));
    setScale(0.75);
    HP = 200;
...
void Professor::decreaseHP(int damage)
{
    HP = HP - damage;
}

void Professor::increaseHP(int heal)
{
    HP = HP + heal;
}

double Professor::distanceTo(QGraphicsItem *item)
{
...
void Professor::fire()
{
    int random_book = rand() % 5;

    if(random_book == 0)
    {
        Arrow * arrow = new Arrow(QString(":/images/book1.png"));
    ...
    {
        Arrow * arrow = new Arrow(QString(":/images/book2.png"));
        arrow->setPos(x()+41,y()+50);
        QLineF ln(QPointF(x()+41,y()+50),attackDest);
        int angle = -1 * ln.angle();
        arrow->setRotation(angle);
    ...
    {
        Arrow * arrow = new Arrow(QString(":/images/book3.png"));
        arrow->setPos(x()+41,y()+50);
        QLineF ln(QPointF(x()+41,y()+50),attackDest);
        int angle = -1 * ln.angle();
        arrow->setRotation(angle);
    ...
    else if(random_book == 3)
    {
        Arrow * arrow = new Arrow(QString(":/images/book4.png"));
        arrow->setPos(x()+41,y()+50);
        QLineF ln(QPointF(x()+41,y()+50),attackDest);
        int angle = -1 * ln.angle();
        arrow->setRotation(angle);
    ...
    else if(random_book == 4)
    {
        Arrow * arrow = new Arrow(QString(":/images/book5.png"));
        arrow->setPos(x()+41,y()+50);
        QLineF ln(QPointF(x()+41,y()+50),attackDest);
        int angle = -1 * ln.angle();
        arrow->setRotation(angle);
