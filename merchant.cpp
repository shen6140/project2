...
Merchant::Merchant(): QObject(), QGraphicsPixmapItem() {
    //set the graphic
    setPixmap(QPixmap(":/images/merchant.png"));
    setScale(0.75);
    HP = 100;
...
void Merchant::decreaseHP(int damage)
{
    HP = HP - damage;
}

void Merchant::increaseHP(int heal)
{
    HP = HP + heal;
}

double Merchant::distanceTo(QGraphicsItem *item)
{
...
void Merchant::fire()
{
    Arrow * arrow = new Arrow(QString(":/images/coin.png"));
