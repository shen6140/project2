...
Taekwondo::Taekwondo(): QObject(), QGraphicsPixmapItem() {
    //set the graphic
    setPixmap(QPixmap(":/images/taekwondo.png"));
    setScale(0.75);
    HP = 200;
...
void Taekwondo::decreaseHP(int damage)
{
    HP = HP - damage;
}

void Taekwondo::increaseHP(int heal)
{
    HP = HP + heal;
}
