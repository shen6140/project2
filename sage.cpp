...
Sage::Sage(): QObject(), QGraphicsPixmapItem() {
    //set the graphic
    setPixmap(QPixmap(":/images/sage.png"));
    setScale(0.75);
    HP = 200;
...
void Sage::decreaseHP(int damage)
{
    HP = HP - damage;
}

void Sage::increaseHP(int heal)
{
    HP = HP + heal;
}

double Sage::distanceTo(QGraphicsItem *item)
{
