...
Wizard::Wizard(): QObject(), QGraphicsPixmapItem() {
    //set the graphic
...
void Wizard::decreaseHP(int damage)
{
    HP = HP - damage;
}

void Wizard::increaseHP(int heal)
{
    HP = HP + heal;
}

double Wizard::distanceTo(QGraphicsItem *item)
{
...
void Wizard::fire()
{
    ...
    {
        Lightning * lightningbolt1 = new Lightning();
        lightningbolt1->setPos(x()-90,y()-20);
        game->scene->addItem(lightningbolt1);

        Lightning * lightningbolt2 = new Lightning();
        lightningbolt2->setPos(x()-60,y()-20);
        game->scene->addItem(lightningbolt2);

        Lightning * lightningbolt3 = new Lightning();
        lightningbolt3->setPos(x()-30,y()-20);
        game->scene->addItem(lightningbolt3);

        Lightning * lightningbolt4 = new Lightning();
        lightningbolt4->setPos(x(),y()-20);
        game->scene->addItem(lightningbolt4);

        Lightning * lightningbolt5 = new Lightning();
        lightningbolt5->setPos(x()+30,y()-20);
        game->scene->addItem(lightningbolt5);

        Lightning * lightningbolt6 = new Lightning();
        lightningbolt6->setPos(x()+60,y()-20);
        game->scene->addItem(lightningbolt6);

        Lightning * lightningbolt7 = new Lightning();
        lightningbolt7->setPos(x()+90,y()-20);
        game->scene->addItem(lightningbolt7);
    }
}
