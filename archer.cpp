...
Archer::Archer(): QObject(), QGraphicsPixmapItem() {
    //set the graphic
...
void Archer::decreaseHP(int damage)
{
    HP = HP - damage;
}

void Archer::increaseHP(int heal)
{
    HP = HP + heal;
}

double Archer::distanceTo(QGraphicsItem *item)
{
